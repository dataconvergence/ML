...
def predict():
    ...
    label="Employee with "+str(int_features)+" years work experience salary should be "+str(output)
    ...
    print(url)
    return render_template('index.html', prediction_text='Employee Salary should be INR {}'.format(output),url1=url)
